...
neoDODO:::load_concept_definitions(toImport, "Disease")
```
...
toImport <- labels %>%
  ...
  distinct()
neoDODO:::load_concept_synonyms(toImport, "Disease")
```
...
neoDODO:::load_alternative_identifiers(toImport, "Disease")
```
...
neoDODO:::load_parent_identifiers(toImport, "Disease", db)
```
