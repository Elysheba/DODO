...
include_graphics(here("inst/documentation/DODO-F1000-publication/fig/disNetExtension.png"))
```
...
include_graphics(here("inst/documentation/DODO-F1000-publication/fig/disNet_equivalence.png"))
```
...
include_graphics(here("inst/documentation/DODO-F1000-publication/fig/get_related_ambiguity_NULL_G409.png"))
